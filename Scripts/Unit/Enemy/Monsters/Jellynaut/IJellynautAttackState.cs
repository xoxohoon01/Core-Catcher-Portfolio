...
public class IJellynautAttackState : IMonsterState
{
    private JellynautController monster;

    public IJellynautAttackState(JellynautController monster)
    {
    ...
    public void OnUpdate()
    {
        ...
        if (Vector3.Distance(monster.transform.position, target.transform.position) <= monster.attackRange)
        {
            ...
            {
                monster.animator.Play("JellynautAttack", 0, 0);
